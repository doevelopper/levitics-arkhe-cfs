                    ...
                    public std::error_category
{
    ...
    public:
        ...
        std::error_code
        make_error_code ( CfsStatusError e );
/*!
 * brief Make_error_code overload to generate custom conditions;
 */
        std::error_condition
        make_error_condition ( CfsStatusError e );
        virtual const char *
        name () const;
        virtual std::string
...
{
    template < >
    struct is_error_code_enum < ErrorCategory::CfsStatusError > :
                                                                public true_type { };
}
